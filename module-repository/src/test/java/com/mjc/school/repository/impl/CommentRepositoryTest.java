...
public class CommentRepositoryTest {
    ...
    public void createTest() {
        ...
        final long id = 1;
        CommentEntity newComment = buildComment(content, 1L);
    ...
    private CommentEntity buildComment(String content, Long newsId) {
        return new CommentEntity(null, content, NewsEntity.newBuilder().setId(newsId).build(), null, null);
    }
}
